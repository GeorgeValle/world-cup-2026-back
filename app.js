...
app.use(cors({
    origin: 'http://fixture-mundial-front.pages.dev', // Tenés que poner la URL EXACTA de tu frontend (no sirve usar '*')
...
app.use((req, res, next) => {
    console.log(`➡️ [TEST] Petición tocando la puerta: ${req.method} ${req.url}`);
    next();
});
